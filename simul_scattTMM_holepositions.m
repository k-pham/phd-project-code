...
xpositions = [ repmat(1536/6*(1:1:5) ,[1,3]) , repelem(1536/2, 4) ];
ypositions = [ repelem(1024/4*(1:1:3), 5)    , 1024/8*(1:2:7)     ];

imgqual = zeros(2,length(xpositions));
...
file_dir_data = 'D:\PROJECT\data\simulations\scattTMM\random 40 80 with water hole - diff positions\100 um\';
file_dir_figs = 'D:\PROJECT\figures\_Matlab figs\simulations\scattTMM\random 40 80 with water hole - diff positions\100 um\';
...
% load('D:\PROJECT\data\simulations\scattTMM\random 40 80 with water hole - diff positions\10 um\random_SCATT_c40_rho80_hole_OBJECT_c1500_rho1000_x768_y896_FILTER_f1_bw20_image_quality.mat')
% load('D:\PROJECT\data\simulations\scattTMM\random 40 80 with water hole - diff positions\100 um\random_SCATT_c40_rho80_hole_OBJECT_c1500_rho1000_x768_y896_FILTER_f1_bw20_image_quality.mat')

% load('D:\PROJECT\data\simulations\scattTMM\random 40 80 with water hole - diff positions\10 um\random_SCATT_c40_rho80_hole_OBJECT_c1500_rho1000_x768_y896_FILTER_f1_bw10_image_quality.mat')
load('D:\PROJECT\data\simulations\scattTMM\random 40 80 with water hole - diff positions\100 um\random_SCATT_c40_rho80_hole_OBJECT_c1500_rho1000_x768_y896_FILTER_f1_bw10_image_quality.mat')
...
figure, scatter(xpositions,ypositions,10), title('hole positions'), xlim([1,1536]), ylim([1,1024])
