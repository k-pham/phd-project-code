...
% modified for finer grid to check if higher frequencies see the hole
...
Nx = 3072;                  % number of grid points in the x (row) direction
Ny = 2048;                  % number of grid points in the y (column) direction
...
fig_data = figure;
imagesc(kgrid.x_vec*1e3,kgrid.t_array(100:end)*1e6,sensor_data(:,100:end)')
